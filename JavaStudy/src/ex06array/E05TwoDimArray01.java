...
public class E05TwoDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 아래와 같이 2차원 배열을 초기화하면 3행 4열짜리 배열이 생성
		 * 초기화 할 원소가 없는 부분은 null로 채워짐
		 * null 값 : 아무것도 없는 값을 일컫는다 즉 빈값을 말함
		 * 스페이스와 같은 공백문자 혹은 0과는 다르다는 것에 주의
		 */
		int[][] arr = {
				{1,2},
				{3,4,5},
		...
		for(int i=0; i<arr.length; i++) {
			// 2차원 배열에서 각 행의 크기는 배여렴ㅇ[인덱스]를 사용
		...
		/*
		 * 2차원 배열에서 특정 요소에 접근하기 위해서는 2개의 배열기호 필요
		 * 또한 값이 없는 원소, 즉 null로 채워져 있는 부분을 출력하면 예외 발생
		 * 배열의 인덱스를 초과했다는 에러가 발생하면서 실행이 종료 
		 */
