...
public class E02SilsuType {
 public static void main(String[] args) {
	 ...
	 /*
	  실수자료형
	  - 정수형보다는 실수형이 더 큰 자료, 0과 1사이에  무한히 많은 실수가 있기 때문
	  = 따라서 long(정수형)과 float(실수형)을 연산하면 float의 결과가 나오게 됨
	  */
	 long long1 = 100;
	 float float1 = 200;
//	 실수형으로 자동형변환됨
...
//	 300.0
	 ...
	 /*
	  ...
	  소수점이 있는 데이터를 float에 대입하려면 접미사 F 혹은 f 사용
	  형변환 후 대입이 가능하지만 권장 X
...
//	 float f4 = 3.14; 
	 ...
	 // float형끼리의 연산은 기본규칙을 따르므로 float
	 float f6 = f3 + f4;
	 System.out.println("f6=" + f6);
	 
	 // float와 double의 연산은 큰 자료형인 double로 반환
	 double d1 = 3.14;
	 double d2 = f6 + d1;
	 System.out.println("d2="+d2);
	 /*
	  CPU는 실수의계산에 기본적인 오차를 가지고 있음
	  Java문제가 아닌 컴퓨터의 태생적인 문제이므로 정확한 계산을 위해서는
	  약간의 보정을 필요로 함
	  */
 }	
}
